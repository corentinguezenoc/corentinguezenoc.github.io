...
**Where's My Leg.** Composition, mixage et mastering d'une bande originale et sound design pour le mini jeu vidéo _Where's My Leg_ dans le cadre du Global Game Jam 2024. L'entièreté de l'audio est fait à partir DE BRUITS DE BOUCHE enregistrés pour l'occasion. Collaborateurs : Jiarui (Ray) Li (Game Design, Programmation, Level Design) et Zisen Ling (Game Design, Programmation, Level Design, Graphismes).
