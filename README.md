...
**Where's My Leg.** Composition, mixage, mastering, et sound design pour le mini jeu vidéo _Where's My Leg_, développé dans le cadre Global Game Jam 2024 avec Jiarui (Ray) Li (Game Design, Programmation, Level Design) et Zisen Ling (Game Design, Programmation, Level Design, Graphismes). Tout l'audio (musique et sound design) ont été réalisés en suivant la contrainte suivante : TOUT FAIRE À PARTIR DE BRUITS DE BOUCHE enregistrés pour l'occasion.
